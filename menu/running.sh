...
if [[ $dropbear_status == "running" ]]; then 
   status_beruangtidur=" ${GREEN}Running${NC} ( No Error )${NC}"
else
   status_beruangtidur="${RED}  Not Running ${NC}  ( Error )${NC}"
fi
...
echo -e ""
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "     ${BIYellow}           SYSTEM INFORMATION IPVPS${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"
